...
/*
This main provides examples for the TimeSeries class
*/
...
int main()  {
  ...
  auto data_oulu_virtual= TS->GetDataVector(station);

  //check if it is well done:
//
  for(int i=0; i<data_oulu_virtual.size();i++){

    cout << data_oulu_virtual[i].first << endl;
  }
